...
* Uses four lines:
  ...
  <br><br><br>It’s usually an active-low signal
  <br><br><br>The master device can select which slave to talk to by setting the SS (slave select) pin to logic low.
